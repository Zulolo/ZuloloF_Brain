...
#define __RF_H
	 ...
	 * UP keeps monitoring if there is any valid frame available (CD, AM, DR should be all SET) on certain channel for 200ms.
	...
	#define NRF905_SAME_FRQ_MAX_TIME						20000		// 200ms, (20000*10us)
